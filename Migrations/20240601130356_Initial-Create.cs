        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_locations_LocId",
                        column: x => x.LocId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_depots", x => x.DepId);
                    table.ForeignKey(
                        name: "FK_depots_locations_LocId",
                        column: x => x.LocId,
                        principalTable: "locations",
                        principalColumn: "LocId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rentals", x => new { x.ClientId, x.VehId, x.DateOfRental });
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_rentals_vehicles_VehId",
                        column: x => x.VehId,
                        principalTable: "vehicles",
                        principalColumn: "VehId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_depots_LocId",
                table: "depots",
                column: "LocId");

            migrationBuilder.CreateIndex(
                name: "IX_rentals_VehId",
                table: "rentals",
                column: "VehId");

            migrationBuilder.CreateIndex(
                name: "IX_vehicles_DepId",
                table: "vehicles",
                column: "DepId");
        }
